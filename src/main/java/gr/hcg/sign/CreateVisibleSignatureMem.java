...
//                Rectangle2D humanRect = new Rectangle2D.Float(20, 20, width-100, 120);
                Rectangle2D humanRect = new Rectangle2D.Float(0, 200, 150, 50);
...
//            PDFont font = PDType0Font.load(doc, new File("../calibri.ttf"));
            PDFont font = PDType0Font.load(doc, new File("src/main/resources/calibri.ttf"));
...
//                cs.fill();
                ...
                PDImageXObject img = PDImageXObject.createFromFileByExtension(new File("image1.png"), doc);
                ...
                cs.showText("Ký bởi: Thuận PL");
                cs.newLine();
                cs.showText("AKAKAKAKA :))");
                cs.endText();
            }
